...
output_fil = os.path.join("/Users/danielkallberg/Documents/KLR_AI/Projekt_MacSpot/macspot-api/AllLocalCodes_history", f"AllLocalCodes_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt")
